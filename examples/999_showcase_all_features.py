...
print("\n Simple String Schema (Shorthand)")
print("-" * 60)
...
print("\n Blank Percentages - Missing Data Simulation")
print("-" * 60)
blank_schema = [
...
print("\n Numeric Ranges - Min/Max Control")
print("-" * 60)
numeric_schema = [
    "product_name",
...
print("\n Custom Lists - Specific Value Options")
print("-" * 60)
list_schema = [
    "first_name",
    "last_name",
