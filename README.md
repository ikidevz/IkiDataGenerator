...
schema = [
    ...
    {"key_label": "datetime", "options": {"from_date": "01/01/2020", "to_date": "12/31/2024"}},
]
```
...
| `datetime`                 | `'07/07/2013'`                                                  | `from_date=None`, `to_date=None`, `date_format='mm/dd/yyyy'`, `minimum_age=None`, `maximum_age=None` |
